export default {
  ...
  chat: {
    filterAll: 'الكل',
    filterMyGroups: 'مجموعاتي',
    filterStudents: 'الطلاب',
    filterTeachers: 'المعلمون',
    filterInstructors: 'المدربون',
    filterParents: 'أولياء الأمور',
    filterDirect: 'مباشر',
    filterAllGroups: 'كل المجموعات',
    defaultUser: 'مستخدم',
    defaultGroup: 'مجموعة دردشة',
    someone: 'شخص ما',
    isTyping: '{{name}} يكتب...',
    peopleTyping: '{{count}} أشخاص يكتبون...',
    imageMessage: '📷 صورة',
    voiceMessage: '🎤 رسالة صوتية',
    youPrefix: 'أنت: {{content}}',
    online: 'متصل',
    today: 'اليوم',
    ...
    voice: 'صوتي',
    photo: 'صورة',
    noChatsMatching: 'لا توجد محادثات تطابق "{{query}}"',
    noInstructorConversations: 'لا توجد محادثات مع المدربين',
    noStudentConversations: 'لا توجد محادثات مع الطلاب',
    noTeacherConversations: 'لا توجد محادثات مع المعلمين',
    noParentConversations: 'لا توجد محادثات مع أولياء الأمور',
    noGroupConversations: 'لا توجد محادثات جماعية',
    noDirectConversations: 'لا توجد محادثات مباشرة',
    noConversationsYet: 'لا توجد محادثات بعد',
    tryAdjustSearch: 'حاول تعديل البحث أو التحقق من الإملاء',
    startChattingInstructors: 'ابدأ المحادثة مع مدربيك',
    connectStudents: 'تواصل مع الطلاب',
    reachTeachers: 'تواصل مع المعلمين',
    connectParents: 'تواصل مع أولياء الأمور',
    browseCourseGroups: 'تصفح مجموعات دوراتك',
    browseAllGroups: 'تصفح كل المجموعات',
    startDirectChat: 'ابدأ محادثة مباشرة',
    startNewConversation: 'ابدأ محادثة جديدة بالضغط على زر + أدناه',
    failedToLoad: 'فشل تحميل المحادثات',
    loadError: 'حدث خطأ أثناء تحميل محادثاتك. يرجى التحقق من الاتصال والمحاولة مرة أخرى.',
    tryAgain: 'حاول مرة أخرى',
    deleteMessageTitle: 'حذف الرسالة',
    deleteMessageBody: 'هل أنت متأكد أنك تريد حذف هذه الرسالة؟ لا يمكن التراجع عن هذا الإجراء.',
    deleteButton: 'حذف',
    removeUserTitle: 'إزالة المستخدم',
    removeUserBody: 'هل أنت متأكد أنك تريد إزالة {{name}} من المجموعة؟',
    removeButton: 'إزالة',
    pinned: 'تم تثبيت الرسالة بنجاح',
    unpinned: 'تم إلغاء تثبيت الرسالة بنجاح',
    copied: 'تم نسخ النص إلى الحافظة',
    userRemoved: 'تمت إزالة {{name}}.',
    failedRemove: 'فشل إزالة المستخدم',
    messageDeleted: 'تم حذف الرسالة بنجاح',
    failedDelete: 'فشل حذف الرسالة',
    failedSend: 'فشل إرسال الرسالة. يرجى المحاولة مرة أخرى.',
    failedUpload: 'فشل رفع الصور. يرجى المحاولة مرة أخرى.',
    cameraPermission: 'مطلوب الوصول إلى الكاميرا لالتقاط الصور',
    microphonePermission: 'مطلوب الوصول إلى الميكروفون لتسجيل الرسائل الصوتية',
