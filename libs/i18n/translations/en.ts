export default {
  ...
  chat: {
    ...
    voice: 'Voice',
    photo: 'Photo',
    noChatsMatching: 'No chats matching "{{query}}"',
    noInstructorConversations: 'No instructor conversations',
    noStudentConversations: 'No student conversations',
    noTeacherConversations: 'No teacher conversations',
    noParentConversations: 'No parent conversations',
    noGroupConversations: 'No group conversations',
    noDirectConversations: 'No direct conversations',
    noConversationsYet: 'No conversations yet',
    tryAdjustSearch: 'Try adjusting your search or check your spelling',
    startChattingInstructors: 'Start chatting with your instructors',
    connectStudents: 'Connect with students',
    reachTeachers: 'Reach out to teachers',
    connectParents: 'Connect with parents',
    browseCourseGroups: 'Browse your course groups',
    browseAllGroups: 'Browse all groups',
    startDirectChat: 'Start a direct chat',
    startNewConversation: 'Start a new conversation by tapping the + button below',
    failedToLoad: 'Failed to load conversations',
    loadError: 'Something went wrong while loading your chats. Please check your connection and try again.',
    tryAgain: 'Try Again',
    deleteMessageTitle: 'Delete Message',
    deleteMessageBody: 'Are you sure you want to delete this message? This action cannot be undone.',
    deleteButton: 'Delete',
    removeUserTitle: 'Remove User',
    removeUserBody: 'Are you sure you want to remove {{name}} from the group?',
    removeButton: 'Remove',
    ...
    failedUpload: 'Failed to upload images. Please try again.',
    cameraPermission: 'Camera access is needed to take photos',
    microphonePermission: 'Microphone access is needed to record voice messages',
    permissionRequired: 'Permission Required',
  },
  reports: {
    title: 'AI Progress Report',
    aiAnalysis: 'Smart Learning Insights',
    description: 'Our AI analyzes attendance patterns, course progress, and engagement to generate a comprehensive summary of your child\'s performance.',
    selectPeriod: 'Report Period',
    weekly: 'Weekly',
    monthly: 'Monthly',
    generate: 'Generate AI Summary',
    download: 'Download PDF Report',
    downloadTitle: 'Download Progress Report',
    downloadSuccess: 'Report downloaded successfully',
    generationStarted: 'AI is analyzing your child\'s progress. We will notify you when the report is ready!',
    infoNote: 'Reports take about 1-2 minutes to generate. We will send you a notification when it\'s ready.',
