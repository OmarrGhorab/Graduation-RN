...
export default function ChatDetailScreen() {
    ...
    const getHeaderInfo = () => {
        if (!conversation) return { name: '...', avatar: '', role: '' };
            ...
            <View style={styles.headerContent}>
                <View style={styles.headerLeft}>
                    ...
                    >
                        <View>
                            <Image
                                source={{ uri: headerInfo.avatar || 'https://lh3.googleusercontent.com/aida-public/AB6AXuBjH3KYd3t7b_k-NYZRgvI4FqWTW5Hhc4Y7QrC9f2v5hNMmneGyKD_cR4SuXcKGq93TY74xPYPghejZcqdI97F7m1A_y5kxsCD98hKd0w87AA06mWj-PV96mnNuYYBwZmCRvDpS_vbAPKlBpdrqLeyAya_3-zkEjHQ2ZPVcFB2BtUN9M0-Rel2ZAaf4WTWqN3k9dCEjz7tgcG1AbGYtwiv5aXlaeRYCwa9QbWNU_kGJNKcnGx-jIam1HkzKSo77tfWbacmjSmgXHHvf' }}
